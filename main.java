 ...
 public static NetflixOriginal instantiateFromInput(Scanner scanner)
{
  ...
  // Keep asking for valid star rating
  while (!valid)
  {
  ...
  return new NetflixOriginal(name, rating, genre);
}
